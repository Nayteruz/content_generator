        ...
        <div className={s.description}>
          {page.description && (
            <>
              ...
              {isHoveredIcon && <div className={s.descriptionText}>{page.description}</div>}
            </>
          )}
        </div>
          ...
          <>
            {isHoveredItem && (
              <div className={s.actionsBtn}>
                ...
                <Button tag="div" size="small" appearance="blue" icon="document" onClick={goToPageInfo}>
                  Добавить наполнение
                </Button>
              </div>
            )}
      ...
      <Modal title="Название раздела" show={renameModal} onClose={() => setRenameModal(false)}>
        <div className={s.modalInner}>
          ...
          <div className={s.modalButtons}>
            <Button tag="div" size="medium" appearance="blue" onClick={onRename}>
              Добавить
            </Button>
            <Button tag="div" size="medium" appearance="gray" color="color-grey" onClick={() => setRenameModal(false)}>
              Отмена
            </Button>
          </div>
        </div>
