      ...
      <div className={s.uploadWrapper}>
        <div className={s.uploadHeader}>
          ...
          <div className={s.uploadBtn}>
            <Button size="small" tag="button" appearance="light_blue" color="color-blue" icon="file-up" onClick={handleFileUpload}>Загрузить</Button>
            <Button size="small" tag="button"  appearance="light_blue" color="color-blue" onClick={onShowModal}>Добавить ссылку</Button>
            <input
              type="file"
              ref={fileInputRef}
              style={{ display: 'none' }}
        ...
        <div className={s.uploadBlock}>
          ...
          <div className={s.upload} onClick={onShowModal}>
      ...
      <Modal show={openModal} onClose={onCloseModal} title="Добавить ссылку на материалы">
        <div className={s.modalInner}>
          ...
          <div className={s.modalButtons}>
            <Button tag="div" size="medium" appearance="blue" onClick={onCloseModal}>Добавить</Button>
            <Button
              tag="div"
              size="medium"
              appearance="gray"
